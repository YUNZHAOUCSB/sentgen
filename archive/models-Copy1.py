...
class SentenceGenerator(object):
    ...
    def build_model(self):
        ...
        #self.rel = tf.placeholder(tf.int32, shape=[None], name='rel') # Batch of relation seeds
        #self.sentence = tf.placeholder(tf.int32, [None, self.n_lstm_steps], name='sentence') # labels
        #self.mask = tf.placeholder(tf.float32, [None, self.n_lstm_steps], name='mask')
        #self.p1 = tf.placeholder(tf.int32, [None], name='p1') #p1_locations
        #self.p2 = tf.placeholder(tf.int32, [None], name = 'p2') #p2_locations
